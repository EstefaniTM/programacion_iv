      ...
      {loading ? (
        ...
        <>
          <FlatList
            ...
            ListEmptyComponent={<Text style={styles.muted}>No hay productos para mostrar.</Text>}
          />

          <PaginationBar page={page} pageSize={pageSize} count={count} onPrev={onPrev} onNext={onNext} />
        </>
      )}
    </View>
  );
