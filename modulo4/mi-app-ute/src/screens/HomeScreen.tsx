  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable
        style={styles.btn}
        onPress={() =>
          navigation.navigate("Details", { id: "p1", title: "Producto 1", detail: "Detalle" })
        }
      >
      ...
      <Pressable
        ...
        >
        <Text style={styles.btnText}>Ir a Demos</Text>
    </Pressable>
    <Pressable
        style={[styles.btn, { marginTop: 10 }]}
    ...
    <Pressable
        ...
        >
        <Text style={styles.btnText}>Ir a Area</Text>
    </Pressable>
    <Pressable
        style={[styles.btn, { marginTop: 10 }]}
    ...
    <Pressable
      style={[styles.btn, { marginTop: 10 }]}
      onPress={() => navigation.navigate("Profile", { userId: "u1", name: "Francisco", lastName: "Higuera"})}
    >
